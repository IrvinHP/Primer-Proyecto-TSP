...
public class NPCNoHilo : MonoBehaviour
{
    ...
    Vector3 GetRandomPositionWithinNavMesh()
    {
        ...
        int triangleIndex = Random.Range(0, triangulation.areas.Length);
    ...
    void FindBestPositionForNPC()
    {
        ...
        {
            newPosNPC.Add(possiblePositions[Random.Range(0, npcs.Count)]);

            PerfomHeavyComputation();
        }
    }
